        ...
        <div class="content container-fluid">
         <div class="row row-broken">
            ...
            <div class="row decor-primary">
                <form  id="addnotice" method="POST"  action="process/edit_notice_process.php">
                <div class="col-sm-12">
                    <div class="input-title">Notice Request</div>
                </div>
				
                       <input class="input__field input__field--minoru" name="id" type="hidden" id="input-13" required="" value="<?php echo $getNotices[0]['fld_id']; ?>" />
				
                <div class="col-sm-12">
                    <span class="input input--minoru">
                        <input class="input__field input__field--minoru" name="reason" type="text" id="input-13" required="" value="<?php echo $getNotices[0]['move_out_reason']; ?>" />
                   ...
                   <div class="col-sm-12">
                    <span class="input input--minoru">
                        <input class="input__field input__field--minoru" name="move_out_date" type="date" id="" required="" value="<?php echo $getNotices[0]['move_out_date']; ?>" />
                        <label class="input__label input__label--minoru" for="input-13">
