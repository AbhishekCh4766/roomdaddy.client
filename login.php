...
<body class="decor-success loginpage">
 <a class="gohome" href="index.php"><i class="fa fa-home"></i> Go to Home Page</a>
              ...
              <div class="account-wall">
				...
				<!--
				 ...
				 <button class="btn btn-lg btn-primary"  onClick="return loginfunction();" type="submit">
					...
					<!-- <button class="btn btn-lg btn-primary second"  onClick="return fillValuesInTextBoxes();" type="submit">
                      Login As Guest
					</button> -->
...
{
    document.getElementById("q1").value = '123456789';
    document.getElementById("q2").value = '1234';
